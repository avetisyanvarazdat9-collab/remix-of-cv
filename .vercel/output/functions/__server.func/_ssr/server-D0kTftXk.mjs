...
import { t as getServerFnById } from "../__23tanstack-start-server-fn-resolver-DfHGlRZ4.mjs";
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-lr330ZEl.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-BPayexUY.mjs"),
		import("./start-YHHi_b3T.mjs"),
