...
const HOME_PAGE_CONTENT_SECTIONS: PageContentEditorSection[] = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: "journeys.students.eyebrow", label: "Card 1 — Eyebrow (Students & Professionals)" },
      { key: "journeys.students.title", label: "Card 1 — Title" },
      { key: "journeys.students.body", label: "Card 1 — Body" },
      { key: "journeys.students.offering1", label: "Card 1 — Offering 1" },
      { key: "journeys.students.offering2", label: "Card 1 — Offering 2" },
      { key: "journeys.students.offering3", label: "Card 1 — Offering 3" },
      { key: "journeys.students.cta", label: "Card 1 — Button label" },
      { key: "journeys.companies.eyebrow", label: "Card 2 — Eyebrow (Companies & Organizations)" },
      { key: "journeys.companies.title", label: "Card 2 — Title" },
      { key: "journeys.companies.body", label: "Card 2 — Body" },
      { key: "journeys.companies.offering1", label: "Card 2 — Offering 1" },
      { key: "journeys.companies.offering2", label: "Card 2 — Offering 2" },
      { key: "journeys.companies.offering3", label: "Card 2 — Offering 3" },
      { key: "journeys.companies.cta", label: "Card 2 — Button label" },
      { key: "journeys.researchers.eyebrow", label: "Card 3 — Eyebrow (Researchers & Universities)" },
      { key: "journeys.researchers.title", label: "Card 3 — Title" },
      { key: "journeys.researchers.body", label: "Card 3 — Body" },
      { key: "journeys.researchers.offering1", label: "Card 3 — Offering 1" },
      { key: "journeys.researchers.offering2", label: "Card 3 — Offering 2" },
      { key: "journeys.researchers.offering3", label: "Card 3 — Offering 3" },
      { key: "journeys.researchers.cta", label: "Card 3 — Button label" },
      { key: "journeys.media.eyebrow", label: "Card 4 — Eyebrow (Media & Public)" },
      { key: "journeys.media.title", label: "Card 4 — Title" },
      { key: "journeys.media.body", label: "Card 4 — Body" },
      { key: "journeys.media.offering1", label: "Card 4 — Offering 1" },
      { key: "journeys.media.offering2", label: "Card 4 — Offering 2" },
      { key: "journeys.media.offering3", label: "Card 4 — Offering 3" },
      { key: "journeys.media.cta", label: "Card 4 — Button label" },
    ],
  },
  {
    heading: "Partners",
    keys: [
      ...
      { key: "partners.category.university", label: "Category label: Universities" },
      { key: "partners.category.company", label: "Category label: Companies" },
      { key: "partners.category.training_center", label: "Category label: Training Centers" },
      { key: "partners.category.other", label: "Category label: Other (uncategorized)" },
