...
export const DICT: Dict = {
  ...
  "courses.filter.all": { hy: "Բոլորը", en: "All", ru: "Все" },
  "courses.filter.online": { hy: "Օնլայն", en: "Online", ru: "Онлайн" },
  "courses.filter.upcoming": { hy: "Առաջիկա", en: "Upcoming", ru: "Предстоящие" },
  "courses.filter.ongoing": { hy: "Ընթացիկ", en: "Ongoing", ru: "Текущие" },
  "courses.filter.completed": { hy: "Ավարտված", en: "Completed", ru: "Завершённые" },
  "courses.filter.topic.all": { hy: "Բոլոր թեմաները", en: "All topics", ru: "Все темы" },
  "courses.status.upcoming": { hy: "Առաջիկա", en: "Upcoming", ru: "Предстоящий" },
  "courses.status.ongoing": { hy: "Ընթացիկ", en: "Ongoing", ru: "Текущий" },
  "courses.status.completed": { hy: "Ավարտված", en: "Completed", ru: "Завершён" },
  ...
  "courses.learnMore": { hy: "Իմանալ ավելին", en: "Learn More", ru: "Подробнее" },
  "courses.topics": { hy: "Թեմաներ", en: "Topics", ru: "Темы" },
  "courses.outcomes": { hy: "Ուսուցման արդյունքներ", en: "Learning Outcomes", ru: "Результаты обучения" },
  "courses.prerequisites": { hy: "Նախապայմաններ", en: "Prerequisites", ru: "Предварительные требования" },
  "courses.instructor": { hy: "Դասախոս", en: "Instructor", ru: "Преподаватель" },
  "courses.enroll": { hy: "Գրանցվել", en: "Enroll", ru: "Записаться" },
  "courses.contact": { hy: "Կապ", en: "Contact", ru: "Связаться" },
  "courses.related": { hy: "Առնչվող", en: "Related", ru: "Похожие" },
  ...
  "video.ungrouped": { hy: "Այլ տեսանյութեր", en: "More videos", ru: "Другие видео" },
